...
public:
	...
	void inorderDepartment(elemType& DNum) const;
	elemType Payrollin(elemType& DNum) const;
...
private:
	...
	void inorderByDepartment(binaryTreeNode<elemType>* p, elemType& depNum) const;
	...
	elemType inorderPayroll(binaryTreeNode<elemType>* p, elemType& depNum) const;
...
template <class elemType>
void binaryTreeType<elemType>::inorderDepartment(elemType& DNum) const
{
	return inorderByDepartment(root, DNum);
}
template <class elemType>
elemType binaryTreeType<elemType>::Payrollin(elemType& Dnum) const
{
	return inorderPayroll(root, Dnum);
}
template <class elemType>
elemType binaryTreeType<elemType>::inorderPayroll(binaryTreeNode<elemType>* p, elemType& depNum) const
{

	if (p != nullptr)
	{
		inorderByDepartment(p->llink,depNum);
		if (p->info == depNum)
		{
			return p->info;
		}
		inorderByDepartment(p->rlink, depNum);
...
template <class elemType>
void binaryTreeType<elemType>::inorderByDepartment(binaryTreeNode<elemType>* p, elemType& depNum) const
{
	elemType dummy;
